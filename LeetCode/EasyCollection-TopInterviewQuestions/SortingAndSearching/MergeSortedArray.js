...
//First Trial
// 그냥 이렇게 해결해보려고 했음
// 리턴하지 말라고 했고 nums1에서 끝내라했으니 ..
// 근데 해당 메모리 주소에서 끝내야하나봄 흠...
...
var merge = function(nums1, m, nums2, n) {
    ...
    nums1.splice(m); //0 제거용으로 사용하나봄
    // 사실 정렬이 뒤로 0 이가도록 되어있어서 상관없을텐데 허허
  for(let i=0; i<n; i++) {
    nums1.push(nums2[i]);
  }
...
//문제점
// 리턴하지말고 메모리에 있는것 그대로 바꾸라하면 할당을 하는로직을 먼저 생각해보자